 ...
 * @property data (StoryDataContainer, optional): The results returned by the call.,
...
data class StoryDataWrapper(
    ...
    @SerializedName("etag")
    @Expose
    val etag: String?, // ebda314158b02ee9aa923b1d7e4518961d8f06c5
)